...
\item Python list of lists of class objects (using {\tt\small \_\_slots\_\_})
\item ROOT GetEntry, TTreeReader, RDataFrame (all in C++), PyROOT
\end{itemize}
...
\item We have to extend that model to handle the variable-length structures that are ubiquitous in HEP data.
\item Opportunities for fundamental work: e.g.\ how do you do gen/reco jet matching in vectorized instructions? \textcolor{gray}{(Part of Jaydeep's project.)}
