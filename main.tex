...
\hfill \textcolor{mycolor}{JaggedArray compute in Python for loops} & 12.9 \\
& \\
\hfill \textcolor{rootnpcolor}{root\_numpy compute in loop over ufuncs} & \ 1.67 \\
...
\hfill \textcolor{rootnpcolor}{root\_numpy load} & \ 1.01 \\
& \\
...
\hfill \textcolor{mycolor}{uproot load} & \ 0.047 \\
\hfill \textcolor{mycolor}{JaggedArray compute as Numpy-like ufunc} & \ 0.030 \\
