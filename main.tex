...
\vspace{-2 cm}
The real problem, though, is doing {\it an analysis} on \\
...
\vspace{-3 cm}
Jaydeep Nandi, our Google Summer of Code student, is investigating \\
...
\begin{frame}{Manipulating columnar data}
\vspace{0.5 cm}
Analysis functions that can't be expressed as explosions, masks, and reductions can at least be JIT-compiled.
...
\begin{frame}{What does this buy us?}
\vspace{0.3 cm}
\begin{columns}
